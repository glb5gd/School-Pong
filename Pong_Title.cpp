...
Title::Title(SDL_Renderer* const & renderer) : Game_Object("Title", "Title")
{
  #include "Pong_Images\\Pong_Title_Img.h"
...
void Title::obj_main(vector<Abstract_Object*> & obj_list, SDL_Renderer* const & renderer, SDL_Event & e)
{
