...
Paddle::Paddle(const string & name, SDL_Renderer* const & renderer, const SDL_Rect & hitbox) : Game_Object("Paddle", name, hitbox)
{
  #include "Pong_Images\\Pong_Paddle_Img.h"
...
void Paddle::obj_main(vector<Abstract_Object*> & obj_list, SDL_Renderer* const & renderer, SDL_Event & e)
{
